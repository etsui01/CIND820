...
The Decision Tree generated with the balanced dataset and k-fold validation performed best. Despite the small increase in balanced accuracy, there was a substantial increase in recall with a small decrease in precision. This desirable trade-off lead to an increase in the F1-score. Detection rate increased as the balanced dataset model was better at identifying true positives.
```{r}
...
```{r}
rf_model_bal <- randomForest(mental_health ~., data = train_set_bal)
